...
export const loginByPhoneQuickAuthResponseTransformer = async (data: any): Promise<LoginByPhoneQuickAuthResponse> => {
    data = sessionWithTokenSchemaResponseTransformer(data);
    return data;
};
