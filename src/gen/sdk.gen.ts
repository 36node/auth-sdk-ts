 ...
 */
export const loginByPhoneQuickAuth = <ThrowOnError extends boolean = true>(options: Options<LoginByPhoneQuickAuthData, ThrowOnError>) => {
    return (options.client ?? client).post<LoginByPhoneQuickAuthResponses, unknown, ThrowOnError>({
        responseTransformer: loginByPhoneQuickAuthResponseTransformer,
 ...
 * delete third party
 */
export const deleteThirdParty = <ThrowOnError extends boolean = true>(options: Options<DeleteThirdPartyData, ThrowOnError>) => {
    return (options.client ?? client).delete<DeleteThirdPartyResponses, unknown, ThrowOnError>({
