 ...
 * List Industries
 */
export const listIndustries = <ThrowOnError extends boolean = true>(options: OptionsLegacyParser<ListIndustriesData, ThrowOnError>) => {
